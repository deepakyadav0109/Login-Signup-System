...
export default function Form() {
  ...
  //const resend = new Resend("re_cBsEo5Fc_HLMqP2572mVpdVx5SQmQyEqD");
...
const [userId, setUserId] = useState(null);
      ...
      .catch((error) => {
        ...
        Swal.fire({
          ...
          text: error.message.includes(
            ...
            : "There is some Error creating the User",
          icon: "error",
          confirmButtonText: "OK",
  ...
  //    from: "deepakyadavdabad0000@gmail.com",
  //    to: [email],
      ...
      <div className="mt-8">
        <form id="form" onSubmit={handleSubmit}>
          ...
          <div className="mt-8 lg:flex gap-3">
            <button
              type="submit"
              className=" w-full lg:w-1/2 active:scale-[0.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl bg-pink-500 text-white text-lg font-bold justify-center items-center"
